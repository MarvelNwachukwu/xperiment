...
export const followPanel: Panel = {
  ...
  render(host: HTMLElement, ctx: ConsoleCtx) {
    host.innerHTML = `
      ...
      <label class="field"><span>Target keywords <small>comma-separated bio filter. Overrides the toggle below; blank falls back to it</small></span><input id="keywords" placeholder="law, attorney, barrister, counsel" /></label>
